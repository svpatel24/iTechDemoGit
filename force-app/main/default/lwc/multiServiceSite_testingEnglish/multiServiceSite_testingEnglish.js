...
import { OMNIDEF } from './multiServiceSite_testingEnglish_def.js';
import tmpl from './multiServiceSite_testingEnglish.html';
import tmpl_nds from './multiServiceSite_testingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class multiServiceSite_testingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
